...
export const ProiezioneSchema = registry.register(
  ...
  z.object({
    id: z
      .string()
      .uuid()
      .openapi({ example: "abc34567-e89b-12d3-a456-426614174999" }),
    sala_id: z
      .string()
      .uuid()
    ...
    data_ora_fine: z
      .string()
      .datetime()
      .openapi({ example: "2026-03-30T12:00:00Z" }),
  }),
);
...
export const updateProiezioneBodySchema = baseCreateProiezioneSchema
  .extend({
    data_ora_fine: z
      .string()
      .datetime("Data e ora di fine non valida")
      .optional(),
  })
  .partial()
...
export type UpdateProiezioneExistenceInput = z.infer<
  typeof updateProiezioneExistenceBodySchema
>;
export type ProiezionePaginationQueryInput = z.infer<
  typeof proiezionePaginationQuerySchema
>;
